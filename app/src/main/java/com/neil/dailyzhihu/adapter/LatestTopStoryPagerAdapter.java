...
public class LatestTopStoryPagerAdapter extends PagerAdapter {
    private List<LatestStory.TopStoriesBean> mTopStoryList;
    ...
    public LatestTopStoryPagerAdapter(Context context, List<LatestStory.TopStoriesBean> topStoriesBeanList) {
     ...
     * @return 单页页卡
     */
    private View getPagerView(LatestStory.TopStoriesBean topStory) {
        ...
        LoaderFactory.getImageLoader().displayImage(iv, topStory.getImages().get(0), null);
