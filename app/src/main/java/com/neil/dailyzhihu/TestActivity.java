...
import com.neil.dailyzhihu.ui.BaseActivity;
...
//        tvTitle= (TextView) findViewById(R.id.title);
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(TestActivity.this, "FAB is clicked", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void buildingCommentPopupWindow() {
        ...
        lv.setAdapter(new ArrayAdapter<String>(this,
                R.layout.lv_menu_item_small_text, new String[]{"长评论", "短评论"}));
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0://长评论
                        Toast.makeText(TestActivity.this, "查看长评论", Toast.LENGTH_SHORT).show();
                        viewLongComments();
                        break;
                    case 1://短评论
                        Toast.makeText(TestActivity.this, "查看短评论", Toast.LENGTH_SHORT).show();
                        viewShortComments();
                        break;
                }
            }
    ...
    private void viewShortComments() {
        ...
        View view = LayoutInflater.from(TestActivity.this).
        ...
        ContentLoader.loadString("http://news-at.zhihu.com/api/4/story/" + storyId + "/short-comments", new ImageLoader.OnFinishListener() {
            ...
            public void onFinish(Object s) {
                ...
                lv2.setAdapter(new LongCommentsAdapter(TestActivity.this, mDatas));
                Toast.makeText(TestActivity.this, "lv:" + lv2.toString() + "adapter有:" + mDatas.size(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void viewLongComments() {
        ...
        ContentLoader.loadString("http://news-at.zhihu.com/api/4/story/" + storyId + "/long-comments", new ImageLoader.OnFinishListener() {
            ...
            public void onFinish(Object s) {
                ...
                LongComments longComments = gson.fromJson((String) s, LongComments.class);
                List<LongComments.CommentsBean> mDatas = longComments.getComments();
                lv1.setAdapter(new LongCommentsAdapter(TestActivity.this, mDatas));
                Toast.makeText(TestActivity.this, "lv:" + lv1.toString() + "adapter有:" + mDatas.size(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void fillingContent(final int storyId) {
        ...
        ContentLoader.loadString("http://news-at.zhihu.com/api/4/news/" + storyId, new ImageLoader.OnFinishListener() {
            ...
            public void onFinish(Object s) {
                ...
                //type=0正常，type特殊情况
                //TODO 图片加载
//                MyApplication myApplication = (MyApplication) TestActivity.this.getApplicationContext();
//                UniversalLoader loader = myApplication.getUniversalLoader();
//                loader.loadImage(TestActivity.this, mImageView, story.getImage(), null);
                ImageLoader.loadImage(mImageView, story.getImage(), null);
