...
import cn.neillee.dailyzhijiu.model.bean.IStoryBean;

import java.util.List;

/**
 * 作者：Neil on 2016/3/23 14:49.
 * 邮箱：cn.neillee@gmail.com
 */
public class LatestStoryListBean extends OriginalStory {
    /**
     * date : 20160322
    ...
    private String date;
    private List<LatestStory> stories;
    ...
    public List<LatestStory> getStories() {
        return stories;
    }
    ...
    public class LatestStory implements IStoryBean {
        /**
     ...
     */
    public class TopStoriesBean implements IStoryBean {
